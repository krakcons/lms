...
export const Scorm12ErrorMessage: Record<Scorm12ErrorCode, { short: string; diagnostic: string }> =
	{
		...
		[Scorm12ErrorCode.NotInitialized]: {
			...
			diagnostic: "Indicates that an API call was made before the call to LMSInitialize.",
		},
