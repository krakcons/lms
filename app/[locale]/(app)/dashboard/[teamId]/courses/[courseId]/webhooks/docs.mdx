...
We have a variety of event types that you can subscribe to. For example, one such event is `learner.created`. Here is a sample payload for `learner.created`:

```
{
  "completedAt": "2024-07-30",
  "courseId": "some string",
  "data": {},
  "email": "some string",
